...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM `filmler` WHERE CONCAT (`Film Adı`, `Salon`) LIKE '%" . $valueToSearch . "%'";
...
<body>
    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col">
                    <form action="index.php" method="POST" name="valueToSearch">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="filmEkle.php" class="btn btn-success btn-lg">+</a>
                        </div>
                    </div>
                </div>
            </div>
